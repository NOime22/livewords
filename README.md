...
<p align="center">
  <em>An AI-powered English vocabulary mini program where every week's word list becomes your own 7-episode TV show.</em>
</p>
...
│   ├── pages/           # 7 pages: welcome / index / masteredWords /
...
├── docs/
│   ├── architecture.md         # ⭐ runtime contracts (this README's source of truth)
